...
const Uvindex = (props) => {
  ...
  useEffect(() => {
    ...
    //   function(d){
    //     return { datetime : d3.timeParse("%Y-%m-%d")(d.datetime), temp : d.uvindex }
    //   },
      ...
      (data) => {
        ...
        var y = d3.scaleLinear()
          .domain([d3.min(data, function(d) { return +d.uvindex; }), d3.max(data, function(d) { return +d.uvindex; })])
          .range([ height, 0 ]);
        ...
        line.append("path")
          ...
          .attr("d", d3.line()
            ...
            .y(function(d) { return y(d.uvindex) })
            )
